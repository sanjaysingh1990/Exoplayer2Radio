...
import org.rajmoh.radio.helpers.SleepTimerService;
...
public final class MainActivityFragment extends Fragment implements TransistorKeys {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
      ...
      /*  StationFetcher stationFetcher = new StationFetcher(mActivity, mFolder, Uri.parse("http://199.195.194.140:8035"));
